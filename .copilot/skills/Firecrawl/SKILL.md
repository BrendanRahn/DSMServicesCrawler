...
Use the env variable FIRECRAWL_API_KEY to get the firecrawl api key to auth
The env variable is declared in the .env in the repo root (excluded from source control)
